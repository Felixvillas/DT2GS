...
exp="evaluation"
prime_envs="8m"
prime_model="adaptive_semantics"
seed_max=30
transformer=1
recurrent_policy=0
hidden_size=64
...
atrous_attention=0
num_mini_batch=8
model_dir=../results/StarCraft2/${prime_envs}/${algo}/${prime_model}/run2/models
...
--latent_dim ${latent_dim} --num_subtask ${num_subtask} --subtask_to_rnn ${subtask_to_rnn} --model_dir ${model_dir} \
--pi_choice ${PI_choice} --subtask_kl_loss ${subtask_kl_loss} \
--only_evaluation 1 --save_replay 1 --record_attention ${record_attention} \
