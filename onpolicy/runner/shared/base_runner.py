...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        if self.all_args.shared_transformer:
            from onpolicy.algorithms.r_mappo.share_r_mappo import Share_R_MAPPO as TrainAlgo
            from onpolicy.algorithms.r_mappo.algorithm.sharerMAPPOPolicy import Share_R_MAPPOPolicy as Policy
        else:
