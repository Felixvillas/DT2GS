...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='entity_product', choices=[
                            "subtask", "subtask_transfer",
                            "entity", "entity_transfer", 
                            "asn",
                            "asn_gatten", "asn_gatten_transfer"
                            "rmappo", "mappo", 
                        ])
    ...
    parser.add_argument("--n_training_threads", type=int,
                        default=127, help="Number of torch threads for training")
    ...
    parser.add_argument("--use_recurrent_policy", type=int,
    ...
    # 默认以下5项全部为False, 记得修改
    parser.add_argument("--use_unified_env", type=int,
                        default=False, help="by default True, whether use the unified smac env.")
    ...
    parser.add_argument("--transformer_orth", type=int,
                        default=False, help="by default True, whether use transformer orthogonal")
    parser.add_argument("--entity_feature", type=int,
                        default=False, help="by default True, whether split obs/state as entity features")
    parser.add_argument("--transformer_heads", type=int,
                        default=3, help="by default True, heads of multi-head attention in transformer")
    ...
    parser.add_argument("--transformer_depth", type=int, 
                        default=1, help="by default 1, number of transformerblock")
    parser.add_argument("--shared_transformer", type=int,
                        default=0, help="by default 0, whether use shared transformer for actor and critic")
    ...
    parser.add_argument("--multi_envs", type=str,
                        default=None, help="by default None, Training Transformer agent on multi envs, such as 8m|3s5z|2s_vs_1sc")
    # pearl parameters
    ...
    parser.add_argument("--pi_choice", type=str, 
                        default="product_subtask", help="the Permutation Invariant way of integrate entity cognition into env cognition")
    parser.add_argument("--subtask_kl_loss", type=int, 
                        default=False, help="whether use the subtasks consistent loss")
    
    # evaluation for evaluating model then save the replay
    parser.add_argument("--only_evaluate", type=int, 
                        default=False, help="without training, only evaluating the model from loading")
    parser.add_argument("--save_replay", type=int, 
                        default=False, help="whether save the replay when only evaluationg the model")
    parser.add_argument("--record_attention", type=int,
                        default=False, help="whether save the attention when evalutating the model, only true when subtasks")
